    ...
    return (
        <div style={{ padding: '30px', ...theme.pageBackground }}>
            ...
            <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
                ...
                {/* BOTÓN NUEVA CITA */}
                <button data-cy="btn-agendar-cita" onClick={() => setMostrarModal(true)} className="btn-hover" style={{ padding: '15px 30px', backgroundColor: '#00A8CC', color: 'white', border: 'none', borderRadius: '10px', fontSize: '15px', fontWeight: 'bold', cursor: 'pointer', marginBottom: '25px', display: 'flex', alignItems: 'center', gap: '10px', boxShadow: '0 4px 10px rgba(0, 168, 204, 0.2)' }}>
